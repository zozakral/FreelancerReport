...
const translations = {
  bg: {
    ...
    'home.subtitle': 'Приложение за месечно отчитане на работа от фрийлансъри.',
    'home.summary': 'Проследявайте месечните часове по компания и дейност, след което генерирайте професионален PDF отчет.',
    'home.feature.track.title': 'Проследяване на отработени часове',
    'home.feature.track.body': 'Въвеждайте часове по месец, компания и дейност в ясна структурирана форма.',
    'home.feature.manage.title': 'Управление на компании и дейности',
    'home.feature.manage.body': 'Поддържайте клиенти и преизползваеми дейности в отделни секции.',
    'home.feature.reports.title': 'Генериране на PDF отчети',
    'home.feature.reports.body': 'Създавайте месечни отчети от шаблони и ги изтегляйте или запазвайте.',
    'home.feature.admin.title': 'Админ възможности',
    'home.feature.admin.body': 'Администраторите могат да управляват потребители и да работят от тяхно име.',
    'home.flow.title': 'Типичен процес',
    'home.flow.step1': 'Създайте профил и влезте в системата.',
    'home.flow.step2': 'Добавете компании и дейности.',
    'home.flow.step3': 'Въведете отработените часове за месеца.',
    'home.flow.step4': 'Генерирайте и изтеглете PDF отчета.',
    ...
    'reports.saved': 'Запазени отчети',
    'reports.noSaved': 'Няма запазени отчети.',
  ...
  en: {
    ...
    'home.heading': 'Freelancer Report',
    'home.subtitle': 'A monthly work reporting app for freelancers.',
    'home.summary': 'Track monthly hours by company and activity, then generate a professional PDF report.',
    'home.feature.track.title': 'Track work entries',
    'home.feature.track.body': 'Enter hours by month, company, and activity in a clear structured format.',
    'home.feature.manage.title': 'Manage companies and activities',
    'home.feature.manage.body': 'Maintain clients and reusable activity definitions in dedicated sections.',
    'home.feature.reports.title': 'Generate PDF reports',
    'home.feature.reports.body': 'Create monthly reports from templates and download or save them.',
    'home.feature.admin.title': 'Admin capabilities',
    'home.feature.admin.body': 'Administrators can manage users and work on behalf of freelancers.',
    'home.flow.title': 'Typical workflow',
    'home.flow.step1': 'Create your profile and sign in.',
    'home.flow.step2': 'Add companies and activities.',
    'home.flow.step3': 'Enter worked hours for the month.',
    'home.flow.step4': 'Generate and download the PDF report.',
